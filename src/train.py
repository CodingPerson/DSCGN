...
def main():
    ...
    parser.add_argument('--web_file', default=None,
                        help='test corpus to conduct model predictions (under dataset directory); one document per line')
    parser.add_argument('--web_label_file', default=None,
                        help='test corpus ground truth label; if provided, model will be evaluated during self-training')
    parser.add_argument('--gold_label_file', default=None,
                        help='test corpus ground truth label; if provided, model will be evaluated during self-training')
    ...
    #chenhu
    parser.add_argument('--match_threshold', type=int, default=10,
    ...
    parser.add_argument('--dist_port', type=int, default=12348,
    ...
    if args.test_file is not None:
        trainer.write_no_split_results(loader_name="mcp_model.pt", out_file="mcp_out.txt")
